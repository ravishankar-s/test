		   ...
		   <div class="row">
            ...
            <div class="col-md-9">
              <div class="box box-primary">
                ...
                <div class="box-footer no-padding">
                  <div class="mailbox-controls">
				   ...
				   <!-- /. Db related div starts -->
				    <div class="box-body" id="viewSupplierDetails">
				...
				<div class="box-body" id="createSupplierDetails" style="display: none;">
              ...
              <div class="row">
                <div class="col-md-6">
                  <div class="form-group">
                   <label>Country</label>                   
                   <s:select name="country_id" headerKey="-1" id="country_id"
					headerValue="--Select Country--" listKey="%{countryId}"
					listValue="%{countryName}" cssClass="form-control select2" list="countryList" style="width:100%" />
                 ...
                 <div class="col-md-6">
                  ...
                  <div class="form-group">
                    <label>State</label>
                   <s:textfield id="zone_id" cssClass="form-control" value="123"
					name="zone_id" placeholder="Enter supplier name ..."/>
              ...
              <s:textarea id="address" cssClass="form-control"
					name="address" rows="3" placeholder="Enter address ..."></s:textarea>
              </div>
              ...
              <div class="col-xs-5">                  
                  <s:textfield id="geocode" cssClass="form-control"
					name="geocode" placeholder="Enter Zip Code ..."/>
                    </div>
              </div>
             ...
             <div class="col-md-6">
              ...
              <div class="col-xs-5">
                 <s:textfield id="cst" cssClass="form-control"
					name="cst" placeholder="Enter CST ..."/>
                    </div>
              </div>
             ...
             <div class="col-md-6">
              ...
              <div class="col-xs-5">
                <s:textfield id="pan" cssClass="form-control"
					name="pan" placeholder="Enter PAN ..."/>
                    </div>
              </div>              
                </div>      
                </div><!-- /.row -->
            ...
            <div class="col-md-6">
              ...
              <s:textarea id="description" cssClass="form-control"
					name="description" rows="3" placeholder="Enter short description ..."></s:textarea>
              </div>
						...
						$('#btnPartyCreate')
								.click(
										function(e) {
											...
											$('#createSupplierDetails').css(
													'display', 'block');
											$('#viewSupplierDetails').css(
													'display', 'none');
        ...
        $(".timepicker").timepicker({
          showInputs: false
			...
			$("#submit").click(function(event) {
				...
				var unitPrice1 = $("#vat").val();
				var partyName1 = $("#partyName").val();
				var uom1 = $("#e1").val();
				if (supplierName == "") {
					$("#supplier_name").focus();
					...
					$('#supplier_name').css('border-color', 'green');
				}
				if (country == "") {
					$("#country_id").focus();
					...
					$('#country_id').css('border-color', 'green');
				}
				if (unitPrice1 == "") {
					$("#vat").focus();
				...
				if (partyName1 == -1) {
					$("#partyName").focus();
					$('#partyName').css('border-color', 'red');
					event.preventDefault();
				} else {
					$('#partyName').css('border-color', 'green');
				}
