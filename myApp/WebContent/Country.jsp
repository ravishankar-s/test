              ...
              <div class="box box-primary">
                ...
                <div class="box-footer no-padding">
                 ...
                 <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
                  <s:if test="%{countryViewList != null }">
										<s:iterator begin="0" end="%{countryViewList.size()-1}"
											status="itStatus">
											...
											<tr>
												...
												<td>
														<s:text
														name="countryViewList[%{#itStatus.index}].countryId" />
														
														</td>
												<td><s:text
														name="countryViewList[%{#itStatus.index}].countryName" /></td> 
												<td><s:text
														name="countryViewList[%{#itStatus.index}].isoCode" /></td>
														
																																				
												
												
												<td><a href=editParty?partyId=<s:text name="partyViewList[%{#itStatus.index}].partyId" /> >Edit</a>
														<a href=deleteParty?partyId=<s:text name="partyViewList[%{#itStatus.index}].partyId" /> >Delete</a></td>
											</tr>
										</s:iterator>
									</s:if>
